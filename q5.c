...
next:
    ...
    switch (ir.b[0]) {
    case 0: return;
    case LIT: regs[IRB(1)] = pgm[pc++].c; NEXT;
    case FOR: lsp+=3; L0=regs[IRB(1)]; L1=regs[IRB(2)]; L2=pc; NEXT;
    case NXT: if (++L0<L1) { pc=L2; } else { lsp-=3; } NEXT;
